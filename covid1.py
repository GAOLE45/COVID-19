...
beta_c = st.text_input('传染率系数',value=0.7)
gamma_c = st.text_input('恢复率系数', value=0.17)
Te_c = st.number_input('潜伏期长度',0,60,value=14)
T_c = st.number_input('预测天数',60,300,value=100)
